...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FORK");
    case mBTC: return QString("mFORK");
    case uBTC: return QString::fromUtf8("μFORK");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ForkCoins"));
    case mBTC: return QString(QObject::tr("Milli-ForkCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ForkCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
